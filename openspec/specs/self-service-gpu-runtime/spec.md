...
Lets a normal Hearsay user with a supported NVIDIA GPU get real CUDA-accelerated transcription without installing Git, Python, PowerShell, or the CUDA Toolkit, or editing environment variables by hand — while never leaving a known-broken CUDA configuration in place.
