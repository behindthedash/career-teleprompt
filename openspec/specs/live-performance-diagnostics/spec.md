...
Lets a normal installed Hearsay user validate whether their machine can sustain Hearsay's live transcription profile from the application itself, without developer tooling.
